        ...
        <div className='h-[500px] w-96 bg-[white] shadow-lg rounded-lg text-black'> 
            ...
            <h2 className='text-3xl font-bold'>SIGN IN</h2>
                <div>
                    ...
                    <br/>
                    <input type='reg_no' placeholder='Enter Registration Number' name='reg_no' className='w-64 py-1 text-black bg-transparent outline-none border-b-2 border-b-spacing-4'
                ...
                <button type='submit' className='bg-[#006957] text-lg w-64 py-3 rounded-md text-white hover:bg-black' >LOGIN</button>
                <p>You agree to our terms and policies.</p>
                <Link to='/signup' className='bg-[#690012] text-lg w-64 flex justify-center items-center py-3 rounded-md text-white hover:bg-black' >CREATE ACCOUNT</Link>
            </form>
        </div>
    </div>
  )
